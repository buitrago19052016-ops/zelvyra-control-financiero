...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    {showConfig && <ConfigModal data={data} onSavePresupuesto={savePresupuesto} onEditMeta={openEditMeta} onDeleteMeta={(id) => setMetaABorrar(metas.find((m) => m.id === id) || null)} onAddMeta={openAddMeta} onCancel={() => setShowConfig(false)} />}

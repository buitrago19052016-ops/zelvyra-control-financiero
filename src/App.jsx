...
function WelcomeSplash({ onContinue }) {
  ...
  return <div className="welcome-splash">
    <img className="welcome-image" src="/resources/welcome-gothic.png" alt="ZELVYRA - inspiración para ahorrar" />
    <div className="welcome-vignette" />
    <div className="welcome-content">
      <img className="welcome-brand-image" src="/resources/zelvyra-logo.png" alt="ZELVYRA — Control Financiero" />
...
export default function App() {
  ...
  return <div className="app-shell">
    <style>{CSS}</style><div className="texture" /><div className="app-frame">
      <header className="brand"><img className="brand-logo" src="/resources/zelvyra-logo.png" alt="ZELVYRA — Control Financiero" />
        <div className="brand-actions"><button className="icon-btn" onClick={() => setShowCalc(true)} title="Calculadora"><Calculator size={18} /></button><button className="icon-btn" onClick={() => setShowConfig(true)} title="Configuración"><Settings2 size={18} /></button></div>
      </header>
